...
export const referenceOperators = [
  ...
  "reference/operators/context/context::create_bloom_filter",
  "reference/operators/context/context::create_geoip",
  "reference/operators/context/context::create_lookup_table",
  "reference/operators/context/context::enrich",
  "reference/operators/context/context::erase",
  "reference/operators/context/context::inspect",
  "reference/operators/context/context::list",
  "reference/operators/context/context::load",
  "reference/operators/context/context::remove",
  "reference/operators/context/context::reset",
  "reference/operators/context/context::save",
  "reference/operators/context/context::update",
  ...
  "reference/operators/package/packag::list",
  "reference/operators/package/package::add",
  "reference/operators/package/package::remove",
  "reference/operators/partitions",
  "reference/operators/pass",
  "reference/operators/pipeline/pipeline::activity",
  "reference/operators/pipeline/pipeline::detach",
  "reference/operators/pipeline/pipeline::list",
  "reference/operators/pipeline/pipeline::run",
