...
<InlineSVG src={props.image} alt="How to send and receive data" />
...
Tenzir can also present a {props.Name}-compatible REST API via the
[`accept_opensearch`](/reference/operators/accept_opensearch) operator.
