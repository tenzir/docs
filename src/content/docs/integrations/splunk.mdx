...
endpoint, use the [`to_splunk`](/reference/operators/to_splunk) operator.
...
[`to_splunk`](/reference/operators/to_splunk) operator.
...
[`from_fluent_bit`](/reference/operators/from_fluent_bit) source operator.
