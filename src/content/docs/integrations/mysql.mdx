...
![MySQL Diagram](mysql.excalidraw)

Tenzir connects to MySQL over the network using the MySQL wire protocol. Tenzir communicates with MySQL via the host and port you specify in the <Op>from_mysql</Op> operator. This means:
