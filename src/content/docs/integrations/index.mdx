...
GitHub](https://github.com/tenzir/library). You can also use
<Guide>ai-workbench/use-agent-skills</Guide> to generate custom packages with
AI assistance.
...
- **Cloud logging**: <Integration>amazon/cloudwatch</Integration>,
  <Integration>google/cloud-logging</Integration>
...
- **Databases and analytics**: <Integration>snowflake</Integration>,
  ...
  <Integration>mysql</Integration>, <Integration>prometheus</Integration>
...
simplifies the user experience. For example, <Op>to_splunk</Op> and
<Op>accept_opensearch</Op> offer a streamlined interface compared to composing
generic HTTP or protocol operators.
:::
