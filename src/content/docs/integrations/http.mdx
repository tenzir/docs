...
sub-pipeline turns the input events into the request body bytes. This is useful
for pushing alerts to webhooks, forwarding events to SIEMs, or sending
periodic batches to external APIs.
