...
- [`read_syslog`](/references/operators/read_syslog): a parser that turns
  unstructured Syslog messages into structured events.
- [`write_syslog`](/references/operators/write_syslog): a printer that
...
[`read_syslog`](/references/operators/read_syslog):
...
Why you throw [`read_syslog`](/references/operators/read_syslog) at this
...
[`parse_cef`](/references/functions/parse_cef):
...
[`write_syslog`](/references/operators/write_syslog).
...
The [`write_syslog`](/references/operators/write_syslog) operator converts
