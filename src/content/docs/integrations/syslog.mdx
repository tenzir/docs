...
[`from_udp`](/reference/operators/from_udp):
...
To use TCP instead of UDP, use [`load_tcp`](/reference/operators/load_tcp) with
...
When you throw [`read_syslog`](/reference/operators/read_syslog) at this
...
[`read_syslog`](/reference/operators/read_syslog) for streaming input and
[`parse_syslog`](/reference/functions/parse_syslog) for parsing individual
