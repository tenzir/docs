...
[`save_kafka`](/references/operators/save_kafka) can send and receive
...
The [`load_kafka`](/references/operators/load_kafka) and
[`save_kafka`](/references/operators/save_kafka) operators can
...
locations]((/references/operators/load_kafka#aws_iam--record-optional))
