...
MSK)](https://aws.amazon.com/msk/) is a managed Kafka service on AWS. It
handles infrastructure and operations, making it easier to run Kafka
applications and Kafka Connect connectors without becoming a Kafka expert.
...
<Op>from_kafka</Op> and
<Op>to_kafka</Op> can send and receive
...
The <Op>from_kafka</Op> and

<Op>to_kafka</Op> operators can
