...
See the [`load_sqs`](/reference/operators/load_sqs) and
[`save_sqs`](/reference/operators/save_sqs) operator documentation for all
available options, including IAM role assumption.
