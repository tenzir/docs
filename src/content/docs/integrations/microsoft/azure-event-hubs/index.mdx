...
[Azure Event Hubs][event-hubs] is a real-time event ingestion service. It can
receive and process millions of events per second, and it provides a Kafka
endpoint for streaming data from Microsoft services to Tenzir.
...
You can process Event Hub events with our <Integration>kafka</Integration> and
<Integration>amqp</Integration> integrations.
