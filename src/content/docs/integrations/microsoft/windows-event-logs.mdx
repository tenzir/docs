...
<Integration>elasticsearch</Integration>/<Integration>opensearch</Integration> integration
...
Use the <Op>from_fluent_bit</Op> source
...
When receiving Windows Event Log data in its native XML format, use

<Fn>parse_winlog</Fn> to convert the XML into
structured records. This function is optimized for the [Windows XML Event Log
