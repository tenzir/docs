...
[decapsulation](/references/functions/decapsulate):
...
[`select`](/references/operators/select) operator performs the equivalent in
...
[`write_zeek_tsv`](/references/operators/write_zeek_tsv):
