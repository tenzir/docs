...
Download the release on [GitHub](https://github.com/tenzir/tenzir/releases/tag/v5.19.0).
...
By [@raxyte](https://github.com/raxyte) in [#5502](https://github.com/tenzir/tenzir/pull/5502).
...
By [@mavam](https://github.com/mavam) in [#5537](https://github.com/tenzir/tenzir/pull/5537).
...
By [@jachris](https://github.com/jachris) in [#5538](https://github.com/tenzir/tenzir/pull/5538).
