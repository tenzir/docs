...
[Tenzir Platform
v1.7](https://github.com/tenzir/platform/releases/tag/v1.7.0):

- This release fixes an issue that causes Demo Nodes to periodically lose
