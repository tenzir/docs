...
#### Expanded dropdown trigger area

We expanded the clickable area for the dropdowns in the navigation strip on pages, so you can now click the selection text as well as the chevron. This makes them easier and more intuitive to open.
