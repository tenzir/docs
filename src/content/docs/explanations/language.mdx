...
blocks to create intricate [pipelines](/explanations/pipeline)
...
- [**Types**](/reference/types): TQL's type system with domain-specific types for security and network data
- [**Expressions**](/reference/expressions): The computational core of TQL, from literals to complex evaluations
- [**Statements**](/reference/statements): Control and structure with bindings, operators, and control flow
- [**Programs**](/reference/programs): Complete data processing workflows and execution model
