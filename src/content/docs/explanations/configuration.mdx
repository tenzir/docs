...
that make outbound connections (e.g., <Op>to_opensearch</Op> and

<Op>to_splunk</Op>) and those that accept inbound connections (e.g.,
<Op>accept_tcp</Op> and <Op>serve_tcp</Op>).
