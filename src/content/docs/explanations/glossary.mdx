...
- Use the [REST API](/reference/api/node) to manage a node
...
- [Control the partition size](/guides/node-setup/tune-performance#control-the-partition-size)
- [Configure catalog and partition indexes](/guides/node-setup/tune-performance#configure-catalog-and-partition-indexes)
- [Select the store format](/guides/node-setup/tune-performance#select-the-store-format)
- [Adjust the store
  compression](/guides/node-setup/tune-performance#adjust-the-store-compression)
- [Rebuild partitions](/guides/node-setup/tune-performance#rebuild-partitions)
