...
- [Tune catalog
  fragmentation](../../guides/setup/node/tune-performance#tune-catalog-fragmentation)
- [Configure the catalog](../../guides/setup/node/tune-performance#configure-the-catalog)
...
- Read more about [enrichment](../enrichment)
...
- Learn more about [pipelines](../architecture/pipeline)
...
- [Ingest data into the node's edge
  storage](../../guides/usage/storage/import-into-a-node)
- [Query the node's edge storage](../../guides/usage/storage/export-from-a-node)
...
- [Does Tenzir have an integration for *X*?](../faqs#do-you-have-an-integration-for-x)
...
- [Collect metrics](../../guides/usage/basics/collect-metrics)
...
- Learn how to provision [piplines as
  code](../../guides/usage/basics/run-pipelines#as-code).

## Package

A collection of [pipelines](#pipeline) and [contexts](#context).

- Read more about [packages](../packages)
...
- Learn more about [pipelines](../architecture/pipeline)
- [Run a pipeline](../../guides/usage/basics/run-pipelines)
...
- Understand the [Tenzir architecture](../architecture)
...
- [Show available schemas in the edge
  storage](../guides/usage/storage/show-available-schemas)
