...
Read more on [how Tenzir works](../how-tenzir-works) to understand what
...
Our [tuning guide](../../guides/setup/node/tune-performance) has further details
on the inner workings.

## Does a Tenzir node run on platform *X*?

We support the platforms that we mention in our [deployment
instructions](../../guides/setup/node/provision-a-node).
