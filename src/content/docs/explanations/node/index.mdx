...
[platform](/explanations/platform), giving you a seamless way to manage and deploy
...
within the same `tenzir-node` process. By default, pipelines run within the same
process. Each approach offers distinct advantages and trade-offs.
