...
![Pipeline Chaining](pipelines/operator-chaining.svg)
...
![Pipeline Structure](pipelines/operator-types.svg)
...
![Upstream and Downstream Types](pipelines/operator-table.svg)
...
![Operator Composition Example 1](pipelines/operator-composition-example-1.svg)
...
![Operator Composition Example 2](pipelines/operator-composition-example-2.svg)
...
![Operator Composition Examples](pipelines/operator-composition-variations.svg)
...
![Multi-schema Example](pipelines/multi-schema-example.svg)
...
![Unified Processing](pipelines/unified-processing.svg)
...
![Database Architecture](pipelines/storage-engine-architecture.svg)
...
![Implicit vs. Explicit](pipelines/implicit-vs-explicit-networking.svg)
...
![Implicit Networking](pipelines/implicit-networking.svg)
...
![Pipeline Fabric](pipelines/pipeline-fabric.excalidraw.svg)
