...
Within assignments, the `take` keyword in front of a field causes a field to be
removed from the input after evaluation. The previous `move` expression keyword
is deprecated.
...
Read our [language documentation](/reference/statements/#assignment)
