...
The [`parallel`](/reference/operators/parallel) operator distributes incoming
events across multiple parallel instances of a subpipeline. Each event is
...
stateful subpipelines like [`deduplicate`](/reference/operators/deduplicate) or
