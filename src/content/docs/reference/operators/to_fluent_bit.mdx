...
You can acquire events from Fluent Bit using the <Op>from_fluent_bit</Op> operator.
:::
...
The `to_fluent_bit` operator can also be used from the <Op>to</Op>
...
- <Op>from_fluent_bit</Op>
- <Integration>fluent-bit</Integration>
