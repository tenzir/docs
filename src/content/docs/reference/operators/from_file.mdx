...
Uses memory-mapped I/O for reading files instead of regular reads. This can
improve performance for large files.

Defaults to `false`.

The pipeline uses the same format and compression inference logic as other file
sources.
