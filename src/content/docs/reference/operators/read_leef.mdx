...
popularized by IBM QRadar. Many tools send LEEF over [Syslog](/references/operators/read_syslog).
...
[`parse_leef`](/references/functions/parse_leef),
[`read_cef`](/references/operators/read_cef)
