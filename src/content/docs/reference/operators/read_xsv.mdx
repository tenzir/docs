...
|---------------------|:-------------:|:------------:|:--------:|
|[`csv`](/references/operators/read_csv)|`,`            |`;`           | empty    |
|[`ssv`](/references/operators/read_ssv)|`<space>`      |`,`           |`-`       |
|[`tsv`](/references/operators/read_tsv)|`\t`           |`,`           |`-`       |
...
[`parse_xsv`](/references/functions/parse_xsv),
[`read_csv`](/references/operators/read_csv),
[`read_ssv`](/references/operators/read_ssv),
[`read_tsv`](/references/operators/read_tsv)
