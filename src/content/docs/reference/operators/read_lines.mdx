...
The `read_lines` operator takes its input bytes and splits it at a newline
character.
...
:::caution[Deprecated]
This option is deprecated. Use <Op>read_delimited</Op> instead.
:::
...
:::caution[Deprecated]
This option is deprecated. Use <Op>read_delimited_regex</Op> instead.
:::

Use the specified regex as the delimiter instead of newline characters. The
regex flavor is Perl compatible and documented
...
:::info
Consider using <Op>read_delimited_regex</Op> for regex-based splitting:
