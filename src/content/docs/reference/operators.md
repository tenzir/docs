...
| Operator                                                   | Description                                               | Example                                                                                                     |
| :--------------------------------------------------------- | :-------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
| [`from`](/reference/operators/from)                        | Reads events from an URI<br/>Creates events from records  | `from "http://example.org/file.csv.gz"`<br/>`from {key: "value"}…` <!--at the top because its important-->  |
...
| [`load_sqs`](/reference/operators/load_sqs)                        | Receives bytes from an Amazon SQS queue        | `load_sqs "sqs://tenzir"`                |
...
| Operator                                                                  | Description                                      | Example                                                                       |
| :------------------------------------------------------------------------ | :----------------------------------------------- | :---------------------------------------------------------------------------- |
| [`to`](/reference/operators/to)                                           | Writes events to an URI                          | `to "s3://examplebucket/obj.json.gz"` <!--at the top because its important--> |
...
| [`save_zmq`](/reference/operators/save_zmq)                           | Saves incoming bytes to ZeroMQ messages         | `save_zmq`                           |
...
| [`write_ssv`](/reference/operators/write_ssv)           | Writes events as SSV                           | `write_ssv`      |
