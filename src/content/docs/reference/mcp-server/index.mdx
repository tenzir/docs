...
:::tip[Quick Start]
Check our [installation guide](/guides/mcp-usage/install-mcp-server) to get up
...
Contexts are defined in `package.yaml` and must be created/populated separately
in the Tenzir Node.
