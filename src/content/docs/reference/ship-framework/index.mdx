...
| Option                | Description                                                |
| --------------------- | ---------------------------------------------------------- |
| `version`             | Release version (for example `v1.0.0` or `v1.0.0-rc.1`)    |
| `--patch`             | Bump patch version from latest stable release              |
| `--minor`             | Bump minor version from latest stable release              |
| `--major`             | Bump major version from latest stable release              |
...
| Input                | Description                                                   |
| -------------------- | ------------------------------------------------------------- |
| `bump`               | Optional stable bump (`auto`, `patch`, `minor`, or `major`)   |
| `version`            | Exact stable version override                                 |
