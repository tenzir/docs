...
The `take` expression moves a field's value and removes the original field
in one atomic operation. Use the `take` keyword in front of a field to move
...
when moving multiple fields. For example, this
