...
This page explains TQL's type system, which provides strong typing with
automatic inference. You get type safety without requiring explicit
declarations. Key characteristics include:
...
The `secret` type is a special type created by the <Fn>secret</Fn>
