...
|---------------------|:-------------:|:------------:|:--------:|
|[`csv`](/references/functions/parse_csv)   |`,`            |`;`           | empty    |
|[`ssv`](/references/functions/parse_ssv)   |`<space>`      |`,`           |`-`       |
|[`tsv`](/references/functions/parse_tsv)   |`\t`           |`,`           |`-`       |
...
[`read_xsv`](/references/operators/read_xsv),
[`parse_csv`](/references/functions/parse_csv),
[`parse_ssv`](/references/functions/parse_ssv),
[`parse_tsv`](/references/functions/parse_tsv)
