...
This function is experimental. The `key` parameter currently accepts a plain
string because function arguments cannot be secrets yet. We plan to change this
in the future.
:::
...
The secret key for the HMAC computation. Currently a plain string; secret
