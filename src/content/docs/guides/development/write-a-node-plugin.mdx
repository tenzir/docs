...
points](/explanations/architecture/plugins#plugin-types), each of which defines its
...
Refer to the [plugin loading](/explanations/configuration#load-plugins) section of
