...
This guide walks you through mapping security logs to the [Open Cybersecurity
Schema Framework](https://schema.ocsf.io/) (OCSF). You'll create a mapping
package that identifies the right event class, generates transformation code,
and validates against the OCSF schema. Two options are available:
