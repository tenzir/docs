...
[`/tql:make_parser`](/reference/workflows/generate-a-parser-package) and
[`/tql:make_ocsf_mapping`](/reference/workflows/generate-an-ocsf-mapping) slash
...
- [Generate a parser](/reference/workflows/generate-a-parser-package) using MCP or the TQL plugin
- [Generate an OCSF mapping](/reference/workflows/generate-an-ocsf-mapping) using MCP or the TQL plugin
