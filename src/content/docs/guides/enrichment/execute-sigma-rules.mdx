...
the [`sigma`](/references/operators/sigma) operator. This allows you to run
...
[`where`](/references/operators/where) operator to the input. At a
high level, the translation process looks as follows:

![Sigma Execution](execute-sigma-rules.svg)

:::note[pySigma Support]
