...
The <Op>context::create_lookup_table</Op>
...
Use the <Op>context::list</Op> operator to
...
Use the <Op>context::remove</Op> operator to
delete a lookup table:
...
entries using the <Op>context::update</Op>
operator:
...
Use the <Op>context::erase</Op> operator to
...
Use the <Op>context::inspect</Op> operator to
...
Use the <Op>every</Op> operator to schedule regular API
...
Use the <Op>context::save</Op> operator to create
...
Use the <Op>context::load</Op> operator to
