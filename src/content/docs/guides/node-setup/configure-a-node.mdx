...
`tenzir.tls` config block. To configure TLS specifically for the platform
connection, see [Platform connection
TLS](/guides/node-setup/configure-tls#platform-connection-tls).
