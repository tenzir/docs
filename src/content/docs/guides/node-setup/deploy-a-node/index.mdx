...
To run a node in AWS, we recommend using [Elastic Container Service (ECS)](...)
which allow you to configure nodes without having to set up EC2 instances.
