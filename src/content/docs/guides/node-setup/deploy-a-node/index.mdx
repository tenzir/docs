...
Check our [changelog](https://tenzir.com/changelog/tenzir/) for the latest version.
...
3. Create a task definition to specify how the Tenzir node container should run.
   ...
   with the desired version. Check the [changelog](https://tenzir.com/changelog/tenzir/) for
   the latest version.
...
later and Helm 3.8 or later.

After [provisioning a node](/guides/node-setup/provision-a-node) in your
Platform workspace, proceed as follows.
...
See the [Tenzir changelog](https://tenzir.com/changelog/tenzir/) for the list of available
...
<Reference>node/helm-chart#change-the-node-configuration</Reference> for
how the chart's checksum annotation decides.
