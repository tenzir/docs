...
![Developer Mode](./rest-api-mode-developer.svg)
...
![Server Mode](./rest-api-mode-server.svg)
...
![Upstream TLS Mode](./rest-api-mode-upstream.svg)
...
![mTLS Mode](./rest-api-mode-mtls.svg)
