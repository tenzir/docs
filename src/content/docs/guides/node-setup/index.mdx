...
The [Tenzir Node](/explanations/node) is the vehicle to run
[pipelines](/explanations/pipeline). It is light-weight server
...
1. [Provisioning](/guides/node-setup/provision-a-node): Create a new node in the
   [platform](/explanations/platform) and obtain a token.
