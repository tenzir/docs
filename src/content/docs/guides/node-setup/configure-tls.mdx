...
:::tip[Platform connection]
To configure TLS for the connection to the Tenzir Platform, see
[Configure TLS for the Platform connection](/guides/node-setup/configure-a-node#configure-tls-for-the-platform-connection).
:::
...
load_http "https://internal.example.com/data", cacert="/path/to/internal-ca.crt"
```
