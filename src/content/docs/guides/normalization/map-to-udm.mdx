...
Install the `tenzir-udm` skill when you want an agent to help with UDM schema
decisions. See
<Guide>ai-workbench/use-agent-skills#use-the-udm-skill</Guide> for
...
- <Guide>ai-workbench/use-agent-skills#use-the-udm-skill</Guide>
