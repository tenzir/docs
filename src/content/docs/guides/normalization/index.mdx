...
### [Package and test mappings](/guides/normalization/package-and-test-mappings)

Make your mappings production-ready:

- Structure mappings as user-defined operators
- Write tests with the test framework
- Validate output with schema casts
...
- [Parse log messages from strings](/guides/parsing/parse-log-messages-from-strings) - Parse before normalizing
- [Create a package](/guides/packages/create-a-package) - Package your mappings
- [Write tests](/guides/testing/write-tests) - Test your mappings
- [Map data to OCSF tutorial](/tutorials/map-data-to-ocsf) - Complete OCSF tutorial
