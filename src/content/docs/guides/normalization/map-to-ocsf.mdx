...
ocsf.metadata = {
  ...
  uid: move ocsf.unmapped.sessionid,
  version: "1.7.0",
}
...
ocsf.connection_info = {
  ...
  protocol_name: ocsf.unmapped.proto,
}
drop ocsf.unmapped.proto
...
- **Isolate source data**: `ocsf.unmapped = this` prevents name clashes and
...
if ocsf.unmapped.type == "TRAFFIC" {
  paloalto::ngfw::ocsf::events::network
} else if ocsf.unmapped.type == "DNS" {
  paloalto::ngfw::ocsf::events::dns
} else if ocsf.unmapped.type == "THREAT" {
