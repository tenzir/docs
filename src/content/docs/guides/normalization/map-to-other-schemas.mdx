...
Map to OCSF first, then translate to other schemas as needed. This gives you a
single source of truth and reduces maintenance burden.
:::

## Elastic Common Schema (ECS)

[ECS](https://www.elastic.co/guide/en/ecs/current/index.html) is Elastic's
open schema for structured data in Elasticsearch.
...
[UDM](https://cloud.google.com/chronicle/docs/reference/udm-field-list) is
Google Chronicle's (SecOps) event schema.
...
- [Map to OCSF](/guides/normalization/map-to-ocsf) - Primary OCSF mapping guide
- [Package and test mappings](/guides/normalization/package-and-test-mappings) - Reusable operators
