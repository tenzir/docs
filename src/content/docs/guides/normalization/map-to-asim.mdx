...
Install the `tenzir-asim` skill when you want an agent to help with ASIM schema
decisions. See
<Guide>ai-workbench/use-agent-skills#use-the-asim-skill</Guide> for
...
- <Guide>ai-workbench/use-agent-skills#use-the-asim-skill</Guide>
