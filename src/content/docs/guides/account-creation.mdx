...
1. Go to [app.tenzir.com](https://app.tenzir.com).
   ![Landing page](./account-creation/land.png)

2. Sign in with your identity provider or password and passkey.
   ![IdP](./account-creation/idp.png)

3. Don't have an account? Click **Sign up** below the Continue button. If you do
   not use an identity provider to sign in, we recommend using a
   [passkey](https://www.passkeys.com/what-are-passkeys.html) as a safer
   alternative to traditional passwords.
  ![Create passkey](./account-creation/create-passkey.png)
...
4. If you created an account with us, you'll receive an email with a link to
  ...
  ![Email verification](./account-creation/email-verified.png)
