...
In Tenzir, the [`fields`](/references/operators/fields) operator
offers the ability for detailed schema introspection. Use it to display all
schema fields; each event represents a single field.
