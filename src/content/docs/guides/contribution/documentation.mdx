...
We build a production build of the site in CI with every push to main. Check out
our [GitHub
workflow](https://github.com/tenzir/docs/blob/main/.github/workflows/astro.yaml)
