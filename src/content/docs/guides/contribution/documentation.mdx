...
| `bun run generate:changelog`  | Generate changelog redirect stubs to [tenzir.com/changelog](https://tenzir.com/changelog) |
...
<Guide>contribution/workflow</Guide> guide.
...
You can use AI-assisted diagramming tools to create and edit `.excalidraw`
files from natural-language prompts. This is useful for generating diagrams
from descriptions or making quick edits without leaving your editor.
:::
