...
[`move`](/reference/expressions/#moving-fields) instead.
...
[`move`](/reference/expressions/#moving-fields) keyword in an assignment to
...
listed fields, an assignment with `move` preserves all other fields.
...
3. **Choose the right operator**:
   ...
   - Use an assignment with `move` when you want to rename fields without
