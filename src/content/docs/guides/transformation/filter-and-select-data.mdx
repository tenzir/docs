...
- [Transform values](/guides/transformation/transform-values) - Learn about value transformations
- [Slice and sample data](/guides/optimization/slice-and-sample-data) - Control the flow of events
- [Reshape complex data](/guides/transformation/reshape-complex-data) - Structural transformations
