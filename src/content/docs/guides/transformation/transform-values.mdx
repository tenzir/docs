...
[`replace`](/reference/operators/replace) to normalize these to actual `null`:
...
- [Filter and select data](/guides/transformation/filter-and-select-data) - Learn about filtering and field selection
- [Manipulate strings](/guides/transformation/manipulate-strings) - Advanced string manipulation techniques
- [Clean up values](/guides/normalization/clean-up-values) - Normalize nulls, sentinels, and types
