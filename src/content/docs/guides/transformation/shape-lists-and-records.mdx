...
- [Filter and select data](/guides/transformation/filter-and-select-data) - Filter entire event streams
- [Transform values](/guides/transformation/transform-values) - Work with simple types
- [Reshape complex data](/guides/transformation/reshape-complex-data) - Advanced structural transformations
