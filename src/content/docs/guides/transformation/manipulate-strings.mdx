...
- [`hash_md5()`](/reference/functions/hash_md5) - MD5 digest (128-bit)
- [`hash_sha1()`](/reference/functions/hash_sha1) - SHA-1 digest (160-bit)
- [`hash_sha224()`](/reference/functions/hash_sha224) - SHA-224 digest
- [`hash_sha256()`](/reference/functions/hash_sha256) - SHA-256 digest
- [`hash_sha384()`](/reference/functions/hash_sha384) - SHA-384 digest
- [`hash_sha512()`](/reference/functions/hash_sha512) - SHA-512 digest
- [`hash_sha3_224()`](/reference/functions/hash_sha3_224) - SHA3-224 digest
- [`hash_sha3_256()`](/reference/functions/hash_sha3_256) - SHA3-256 digest
- [`hash_sha3_384()`](/reference/functions/hash_sha3_384) - SHA3-384 digest
- [`hash_sha3_512()`](/reference/functions/hash_sha3_512) - SHA3-512 digest
- [`hash_xxh3()`](/reference/functions/hash_xxh3) - XXH3 digest (fast, 64-bit)
...
- [Parse log messages from strings](/guides/parsing/parse-log-messages-from-strings) -
  Parse complex text formats
- [Transform values](/guides/transformation/transform-values) -
  Convert between data types
- [Filter and select data](/guides/transformation/filter-and-select-data) - Use
