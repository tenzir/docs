...
- <Fn>to_lower</Fn> - Converts all characters to
lowercase
- <Fn>to_upper</Fn> - Converts all characters to
uppercase
- <Fn>to_title</Fn> - Capitalizes first letter of
each word
- <Fn>capitalize</Fn> - Capitalizes only the first
letter
...
- <Fn>trim</Fn> - Removes whitespace from both ends
- <Fn>trim_start</Fn> - Removes whitespace from
beginning
- <Fn>trim_end</Fn> - Removes whitespace from end
...
Use <Fn>split_regex</Fn> for complex splitting:
...
Use <Fn>replace_regex</Fn> for complex
replacements:
...
- <Fn>match_regex</Fn> - Test against regular
expression
...
- <Fn>is_numeric</Fn> - Contains only digits
- <Fn>is_alpha</Fn> - Contains only letters
- <Fn>is_alnum</Fn> - Contains only letters and
digits
- <Fn>is_lower</Fn> - All cased characters are
lowercase
- <Fn>is_upper</Fn> - All cased characters are
uppercase
- <Fn>is_title</Fn> - String is in title case
- <Fn>is_printable</Fn> - Contains only
...
- <Fn>length_chars</Fn> - Count Unicode
characters
- <Fn>length_bytes</Fn> - Count bytes
- <Fn>reverse</Fn> - Reverse character order
- <Fn>file_name</Fn> - Extract filename from path
- <Fn>parent_dir</Fn> - Extract directory from
path

## Extract substrings

Use <Fn>slice</Fn> to extract portions of strings:
...
- <Fn>pad_start</Fn> - Add characters to the
beginning
...
The <Fn>file_contents</Fn> function reads the
...
- <Fn>hash_md5</Fn> - MD5 digest (128-bit)
- <Fn>hash_sha1</Fn> - SHA-1 digest (160-bit)
- <Fn>hash_sha224</Fn> - SHA-224 digest
- <Fn>hash_sha256</Fn> - SHA-256 digest
- <Fn>hash_sha384</Fn> - SHA-384 digest
- <Fn>hash_sha512</Fn> - SHA-512 digest
- <Fn>hash_sha3_224</Fn> - SHA3-224 digest
- <Fn>hash_sha3_256</Fn> - SHA3-256 digest
- <Fn>hash_sha3_384</Fn> - SHA3-384 digest
- <Fn>hash_sha3_512</Fn> - SHA3-512 digest
- <Fn>hash_xxh3</Fn> - XXH3 digest (fast, 64-bit)
...
Use <Fn>community_id</Fn> to create standardized
flow hashes:
...
Use <Fn>encrypt_cryptopan</Fn> for
