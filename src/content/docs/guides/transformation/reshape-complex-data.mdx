...
Reconstruct hierarchical structures from flattened data using <Fn>unflatten</Fn>:
...
Some data sources aggregate multiple events into a single record. Use <Op>unroll</Op> to expand these into individual events:
