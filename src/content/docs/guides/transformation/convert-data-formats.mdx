...
<Fn>print_json</Fn> to convert any data to JSON
strings:
...
The <Fn>print_json</Fn> function has

<Op>write_json</Op> as sibling operator to format
...
<Op>write_ssv</Op> because space is overloaded as
field separator.
...
<Fn>print_xsv</Fn> function to customize field
