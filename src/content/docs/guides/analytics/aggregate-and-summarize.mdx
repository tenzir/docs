...
- [Shape lists and records](/guides/transformation/shape-lists-and-records) - Work with lists and records
- [Filter and select data](/guides/transformation/filter-and-select-data) - Filter before aggregating
- [Slice and sample data](/guides/optimization/slice-and-sample-data) - Control data flow
