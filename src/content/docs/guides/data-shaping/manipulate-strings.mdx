...
set decoded_blob = hex_string.decode_hex()
```
...
set padded_id = id.pad_start(5, "0")
set padded_code = code.pad_end(10, "-")
```
...
```tql
from {}
set hostname = file_contents("/etc/hostname")
```
...
set badge = dept.to_upper().slice(begin=0, end=3) + "-" + id.string()
```
...
set anon_client = client_ip.encrypt_cryptopan(seed="mysecretkey12345")
set anon_server = server_ip.encrypt_cryptopan(seed="mysecretkey12345")
set anon_internal = internal_ip.encrypt_cryptopan(seed="mysecretkey12345")
```
