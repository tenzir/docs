...
JSON is the most common data exchange format. Use [`print_json()`](/reference/functions/print_json)
to convert any data to JSON strings:
...
For tab-separated and space-separated values, use [`print_tsv()`](/reference/functions/print_tsv)
and [`print_ssv()`](/reference/functions/print_ssv):
