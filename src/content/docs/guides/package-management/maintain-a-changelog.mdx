...
[`tenzir-ship`](/reference/ship-framework) to manage changelog
...
This exports every release as a JSON array, which is useful for documentation
sync scripts that need all release data at once.
