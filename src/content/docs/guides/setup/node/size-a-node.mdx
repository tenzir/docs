...
[Shaping](../../guides/usage/data/shape-data) operation changes the form of the
...
[importing](../../guides/usage/storage/import-into-a-node) and
[exporting](../../guides/usage/storage/export-from-a-node) data, you need
