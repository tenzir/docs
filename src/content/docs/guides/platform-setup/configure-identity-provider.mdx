...
can also force the use of the client credentials flow by using the
...
![Configuration 0](configure-identity-provider/keycloak_create_realm.png)
...
![Configuration 0](configure-identity-provider/keycloak_create_app_client_0.png)

Under "Capability config", enable client authentication and the "Standard flow"
access method.

![Configuration 1](configure-identity-provider/keycloak_create_app_client_1.png)
...
![Configuration 2](configure-identity-provider/keycloak_create_app_client_2.png)
...
![Configuration 3](configure-identity-provider/keycloak_create_app_client_3.png)
...
![Create CLI client](configure-identity-provider/keycloak_create_cli_client_0.png)
