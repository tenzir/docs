...
1. <Guide>platform-setup/choose-a-scenario</Guide>: we package
...
2. Configure the services: you must set up the external API endpoints so nodes
   ...
   - <Guide>platform-setup/configure-reverse-proxy</Guide>
   - <Guide>platform-setup/configure-internal-services</Guide>
   - <Guide>platform-setup/configure-identity-provider</Guide>
   - <Guide>platform-setup/configure-database</Guide>
   - <Guide>platform-setup/configure-blob-storage</Guide>

   You may skip some steps depending on your chosen scenario.

3. <Guide>platform-setup/run-the-platform</Guide>: After you create
...
1. <Guide>platform-management/configure-workspaces</Guide>
2. <Guide>platform-management/configure-dashboards</Guide>
3. <Guide>platform-management/use-ephemeral-nodes</Guide>
:::
