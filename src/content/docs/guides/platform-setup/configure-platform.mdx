---
title: Configuring the Platform
---
...
Admin users have the permission to create new workspaces and to view, edit and
...
functions. These should be generated from a secure random number generator and
be unique for each instance of the Tenzir Platform.
