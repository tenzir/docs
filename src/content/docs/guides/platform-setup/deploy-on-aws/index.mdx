...
![Platform AWS Architecture](./aws-architecture.svg)
...
6. Configure the parameters:
   ...
   - **UI Container Image**: Full image URI with the `latest` tag you pushed in Step 2
     (e.g., `123456789012.dkr.ecr.us-east-1.amazonaws.com/tenzir/tenzir-platform-ui:latest`)
   - **API Container Image**: Full image URI with the `latest` tag you pushed in Step 2
     (e.g., `123456789012.dkr.ecr.us-east-1.amazonaws.com/tenzir/tenzir-platform-api:latest`)
   - **Gateway Container Image**: Full image URI with the `latest` tag you pushed in Step 2
     (e.g., `123456789012.dkr.ecr.us-east-1.amazonaws.com/tenzir/tenzir-platform-gateway:latest`)
