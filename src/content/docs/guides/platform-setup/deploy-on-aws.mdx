...
## Step 2: Create ECR repositories and copy images

Before deploying the CloudFormation stack, you need to create ECR repositories and
copy the container images from the AWS Marketplace.

<Tabs>
<TabItem value="script" label="Automated script">

Use this script to create the ECR repositories and copy the container images from the AWS Marketplace to your local ECR repositories:
...
The script copies all four container images to your ECR repositories. This process
...
Create four ECR repositories using the AWS Console:
...
# Copy each image
for IMAGE in ui api gateway node; do
...
aws cloudformation create-stack \
  ...
  --parameters \
    ...
    ParameterKey=Version,ParameterValue=v0.1.0 \
...
6. Configure the parameters:
   ...
   - **Platform Version**: The version tag for container images (must match the
     version you copied in Step 2, e.g., `v0.1.0`)
...
- **Domain Configuration**:
  ...
  - `Version`: Container image version tag (default: `v0.1.0`)
...
- **ECR Repositories**: Store container images for UI, API, Gateway, and Node
  services
