...
provide a valid access key with read and write permissions on the
bucket.

When you use the bundled seaweed instance, you can set these values to arbitrary
strings. The bundled seaweed container automatically provides
a bucket with the specified name and access key.
