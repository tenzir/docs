...
data flow. Use enabled pipelines only when the package should take action as
soon as it is installed. Ship ingestion, export, and publishing workflows as
disabled templates unless automatic execution is the package's core behavior.
