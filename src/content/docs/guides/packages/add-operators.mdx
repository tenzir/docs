...
The dispatcher operator keeps source residue in a product-specific `acme`
namespace, adds shared OCSF fields, routes events to specialized mappers based
on a stable event discriminator, and returns the mapped OCSF event:
