...
Consider a package that normalizes various event types to OCSF. Keep
source-specific cleanup, shared OCSF setup, and dispatch in one main mapper,
then delegate only event-specific mapping details to leaf operators:
