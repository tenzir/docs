...
The [app](https://app.tenzir.com/) or [API](/references/api/node) allow
...
1. Click the button corresponding to the desired action, i.e., *Start*, *Pause*,
   *Stop*, or *Delete*.
1. Confirm your selection.

</Steps>

For the [API](/references/api/node), use the following endpoints based on
the desired actions:
