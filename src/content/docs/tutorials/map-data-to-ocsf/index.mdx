...
1. With `ocsf.unmapped = this`, we create a dedicated OCSF record and keep the
   original event as mapping residue. This approach avoids name clashes when we
   create new fields in the next steps.
