...
up](/guides/node-setup/deploy-a-node/) and then test the installation:
...
the Tenzir ecosystem, it is actually quite fun. 🕺
...
test node interactions, we need to use the _suite_ concept from the test
